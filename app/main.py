...
def login_page(request: Request):
    ...
    """
    return templates.TemplateResponse(request, name="login.html", context={"request": request})
...
def register_page(request: Request):
    ...
    """
    return templates.TemplateResponse(request, name="register.html", context={"request": request})
...
def dashboard_page(request: Request):
    ...
    """
    return templates.TemplateResponse(request, name="dashboard.html", context={"request": request})
...
def view_calculation_page(request: Request, calc_id: str):
    ...
    """
    return templates.TemplateResponse(request, name="view_calculation.html", context={"request": request, "calc_id": calc_id})
